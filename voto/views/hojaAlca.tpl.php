                ...
                <p class="lead">Elección de <?= $objHoja[0]['anio'];?>.<br>
                 ...
                 <div class="panel panel-warning">
                   ...
                   <div class="panel-body">
                      <form "form-horizontal" method="post" action="hojaAlcalde">
                  ...
                  <img src="web/img/<?= $data['src_img']; ?>" class='img-circle' style='width:100px; height:100px;'/>
                    <div class="radio">
                      ...
                      <input type="radio" name="id_candidato" id="blankRadio1" value="<?= $data['idcandidato'];?>" aria-label="" >
                       <?= $data['nombres'].'&nbsp'.$data['apellidos']?></br>
                      </label>
                    </div>
              </div>
    <?php endforeach; ?>
             ...
             <div class="text-center">
                <button type="submit" name="btnA" class="btn btn-info">Enviar Voto</button>
             </div>
                      </form>
                   </div>
                 </div>
