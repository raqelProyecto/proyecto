            ...
            <div class="col-md-12">
                ...
                <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="nombre" class="form-control" id="nombre" value="<?= $objPartido[0]['nombre'] ?>" placeholder="DONA">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="DUI" class=" col-sm-2 control-label">DUI: </label>
                        <div class="col-sm-10">
                            <input type="text" name="DUI" class="form-control" id="DUI" value="<?= $objPartido[0]['DUI'] ?>" placeholder="XXXXXXXX-X">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="represent" class="form-control" id="nombre" value="<?= $objPartido[0]['represent'] ?>" placeholder="DONA">
                        </div>
                    </div>
                    <input type="hidden" name="partido_id" value="<?= $_REQUEST['id']?>">
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary" name="btn" >Actualizar Partido</button>
                        </div>
                    </div>
                </form>
            </div>
