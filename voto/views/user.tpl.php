          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li class="divider"></li>
                 <li><a href="listaVotantes">lista de votantes</li>
...
<div class="container">
       <div class="starter-template">
        ...
        <p class="lead">Bienvenida May .<br>
      ...
      <div class="row">
        ...
        <table class="table table-hover">
         ...
         <tbody>
           ...
           <tr>
               <th><a href="registroVotante">Registrar Votante</a></th>
               <th> bla bla bla ...</th>
           </tr>
           
           <tr>
               <th><a href="listaVotantes">Lista Votantes</a></th>
               <th> bla bla bla ...</th>
           </tr>
         </tbody>
        </table>
