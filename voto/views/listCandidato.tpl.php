...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
         <div class="starter-template">
             ...
             <p class="lead">Lista de Candidatos<br>
                 <span class="glyphicon glyphicon-arrow-down" aria-hidden="true">
                      ...
                      <div class="panel panel-warning">
                          <div class="panel-heading">
                            <h3 class="panel-title text-center">Lista Candidatos</h3>
                          </div>
          <div class="panel-body">
           <?php echo imprimirtabla($objCandidatos,'candidato','table table-striped',1); ?>
